...
class CustomerServiceSystem:
    ...
    def _classify_inquiry(self, model: str, image_path: str = None, text: str = None):
        prompt = """你是一个专业的客服咨询分类助手。请仔细分析用户提供的文本和图片内容，将咨询内容准确分类到以下类别之一：
...
分析要求：
- 深度理解用户的文本和图片含义，而不是只停留在表层和只通过关键词进行分类
...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        #     "model": "text_only"  # 可选值："text_only", "image_only", "image_and_text"
        # },
        # {
